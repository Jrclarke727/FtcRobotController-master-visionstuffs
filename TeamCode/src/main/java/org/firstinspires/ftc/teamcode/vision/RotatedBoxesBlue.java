...
public class RotatedBoxesBlue extends OpenCvPipeline {

	public double cX = 0;
	public double cY = 0;
	public double width = 0;

	public Scalar lowerHSV = new Scalar(104.0, 0.0, 0.0, 0.0);
	public Scalar upperHSV = new Scalar(123.0, 255.0, 255.0, 0.0);
	...
	public Scalar lineColor = new Scalar(255.0, 255.0, 0.0, 0.0);
	public int lineThickness = 4;

	private Mat inputRotRects = new Mat();

	// List to store centers of rotated rectangles
