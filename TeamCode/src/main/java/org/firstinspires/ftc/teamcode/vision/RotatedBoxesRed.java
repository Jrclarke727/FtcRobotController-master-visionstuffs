...
public class RotatedBoxesRed extends OpenCvPipeline {

	public double cX = 0;
	public double cY = 0;
	public double width = 0;

	public Scalar lowerHSV = new Scalar(0.0, 135.5, 0.0, 0.0);
	public Scalar upperHSV = new Scalar(19.0, 230.0, 255.0, 0.0);
	...
	public Mat processFrame(Mat input) {
		...
		for (RotatedRect rect : contoursByAreaRotRects) {
			if (rect != null) {
				...
				Imgproc.line(inputRotRects, end1, end2, new Scalar(255.0, 255, 0), 2);
